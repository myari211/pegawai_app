        ...
        <div class="btn-group dropleft">
            ...
            <ul class="dropdown-menu mr-2 p-2 bg-secondary" style="height:15rem">
                ...
                <li class="d-flex align-items-end justify-content-center">
                    <button type="button" class="btn btn-danger shadow" href="{{ route('logout') }}" onClick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</button>
                </li>
            </ul>
        </div>
